//+------------------------------------------------------------------+
//| Strategy 2.22.100 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 10/02/2025 01:26
//| 
//|    Backtested on BTCUSD / H1, 2017.05.08 - 2025.09.30 
//+------------------------------------------------------------------+
...
input string CustomComment = "NEXOR_BTCUSD_Strategy_2_22_100";
...
input int TEMAPeriod1 = 13;        //TEMAPeriod1
input int TEMAPeriod2 = 20;        //TEMAPeriod2
input int StochasticKPeriod1 = 5;        //StochasticKPeriod1
input int StochasticDPeriod1 = 3;        //StochasticDPeriod1
input int StochasticSlowing1 = 3;        //StochasticSlowing1
input double ProfitTargetCoef1 = 1.1;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.1;        //StopLossCoef1
input double ProfitTargetCoef2 = 2.2;        //ProfitTargetCoef2
input double StopLossCoef2 = 1;        //StopLossCoef2
...
input string FridayExitTime = "23:40";
...
#define TEMA_1 0     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_CLOSE)
#define TEMA_2 1     //iTEMA(NULL,0, TEMAPeriod2, 0, PRICE_CLOSE)
#define STOCHASTIC_1 2     //iCustom(NULL,0, "SqStochastic", StochasticKPeriod1, StochasticDPeriod1, StochasticSlowing1, MODE_EMA, STO_LOWHIGH)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 24)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 29)
...
string sqStrategyName = "Strategy 2.22.100";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(TEMA_1, 0, 1), 6) >= NormalizeDouble((double) sqGetIndicatorValue(TEMA_2, 0, 2), 6));

     ShortEntrySignal = ((sqIsGreaterCount("sqGetIndicatorValue(STOCHASTIC_1, 1, 2)","sqTimeHour(sqTime(NULL,0, 3))",2,false,3))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(TEMA_2, 0, 2), 6) >= NormalizeDouble((double) SessionOpen(NULL,0, 16, 59, 2), 6)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_2] = iTEMA(NULL,0, TEMAPeriod2, 0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[STOCHASTIC_1] = iCustom(NULL,0, "SqStochastic", StochasticKPeriod1, StochasticDPeriod1, StochasticSlowing1, MODE_EMA, STO_LOWHIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 24);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 29);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(STOCHASTIC_1, 1, 2)") {
          return sqGetIndicatorValue(STOCHASTIC_1, 1, shift + 2);
      }
      if(id == "sqTimeHour(sqTime(NULL,0, 3))") {
          return   sqTimeHour(sqTime(NULL,0, shift + 3));
      }
